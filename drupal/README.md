...
To use the vagrant file, you will need to have done the following:
  ...
  5. This Ansible playbook uses a variety of roles to configure the Drupal server, and you'll need to install the roles before you can get the VM set up. Run the following command to get all the necessary roles: `$ ansible-galaxy install geerlingguy.firewall geerlingguy.ntp geerlingguy.repo-epel geerlingguy.repo-remi geerlingguy.mysql geerlingguy.apache geerlingguy.php geerlingguy.php-mysql geerlingguy.composer geerlingguy.drush geerlingguy.drupal`
